...
\begin{frame}{Visual Overview}
  \begin{columns}[T,totalwidth=\textwidth]
    \begin{column}{0.55\textwidth}
      \begin{figure}[h]
        \centering
        \includegraphics[width=0.48\textwidth,height=1.7cm,keepaspectratio]{img/0000.jpg}\hfill
        \includegraphics[width=0.48\textwidth,height=1.7cm,keepaspectratio]{img/0001.jpg}\\[0.1cm]
        \includegraphics[width=0.48\textwidth,height=1.7cm,keepaspectratio]{img/0002.jpg}\hfill
        \includegraphics[width=0.48\textwidth,height=1.7cm,keepaspectratio]{img/0003.jpg}\\[0.2cm]
        \includegraphics[width=\textwidth,height=2.1cm,keepaspectratio]{img/panorama_window_0_to_3.jpg}
      \end{figure}
    \end{column}
